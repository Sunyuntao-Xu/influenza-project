...
seqkit subseq -r 113:2263 China_UK_PA_NT_aligned.fasta -o China_UK_PA_NT_aligned_trimmed.fasta
...
seqkit stats China_UK_PA_NT_aligned.fasta China_UK_PA_NT_aligned_trimmed.fasta
